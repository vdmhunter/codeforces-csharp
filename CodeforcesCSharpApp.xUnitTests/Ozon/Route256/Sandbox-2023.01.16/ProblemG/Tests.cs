...
using CodeforcesCSharpApp.Ozon.Route256.Sandbox_20230116.ProblemG01;
using CodeforcesCSharpApp.xUnitTests.Common;
using Xunit;
using Xunit.Abstractions;

namespace CodeforcesCSharpApp.xUnitTests.Ozon.Route256.Sandbox_20230116.ProblemG;

[ExcludeFromCodeCoverage]
public class Tests
{
    private const string ProblemLetter = "G";
