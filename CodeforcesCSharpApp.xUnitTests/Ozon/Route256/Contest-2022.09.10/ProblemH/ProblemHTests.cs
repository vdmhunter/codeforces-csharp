...
using Solution01 = CodeforcesCSharpApp.Ozon.Route256.Contest_20220910.ProblemH01;

namespace CodeforcesCSharpApp.xUnitTests.Ozon.Route256.Contest_20220910.ProblemH;

[ExcludeFromCodeCoverage]
public class ProblemHTests
{
    private const string ProblemName = "ProblemH";
    private const string ProblemDescription = "OZON || Route256 || Contest (10.09.2022) - Problem H";
