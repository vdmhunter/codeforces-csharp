...
using Solution01 = CodeforcesCSharpApp.Ozon.Route256.Contest_20220910.ProblemG01;

namespace CodeforcesCSharpApp.xUnitTests.Ozon.Route256.Contest_20220910.ProblemG;

[ExcludeFromCodeCoverage]
public class ProblemATests
{
    private const string ProblemName = "ProblemG";
    private const string ProblemDescription = "OZON || Route256 || Contest (10.09.2022) - Problem G";
